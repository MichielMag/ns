...
var API = /** @class */ (function () {
    ...
    API.prototype.getAllStations = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.ALLSTATIONSURL, null)
    ...
    API.prototype.getArrivals = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.ARRIVALSURL, params)
                .subscribe(function (message) {
                resolve(message.payload);
            }, function (error) {
                reject(error);
    ...
    API.prototype.getDepartures = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.DEPARTURESURL, params)
                .subscribe(function (message) {
                resolve(message.payload);
            }, function (error) {
                reject(error);
    ...
    API.prototype.getBigDepartures = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.BIGDEPARTURESURL, params)
                .subscribe(function (message) {
                resolve(message.payload);
            }, function (error) {
                reject(error);
    ...
    API.prototype.getDisruption = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.DISRUPTIONURL + params.id, params)
                .subscribe(function (message) {
                resolve(message.payload);
            }, function (error) {
                reject(error);
    ...
    API.prototype.getDisruptions = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.DISRUPTIONSURL, params)
                .subscribe(function (message) {
                resolve(message.payload);
            }, function (error) {
                reject(error);
    ...
    API.prototype.getStationDisruption = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.STATIONDISRUPTIONURL + params.code, params)
                .subscribe(function (message) {
                resolve(message.payload);
            }, function (error) {
                reject(error);
    ...
    API.prototype.getTrip = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.TRIPURL, params)
                .subscribe(function (message) {
                resolve(message.payload);
            }, function (error) {
                reject(error);
    ...
    API.prototype.getTrips = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.TRIPSURL, params)
                .subscribe(function (message) {
                resolve(message.payload);
            }, function (error) {
                reject(error);
