export declare enum CommutingType {
    Bike = "BIKE",
    Bus = "BUS",
    Car = "CAR",
    Ferry = "FERRY",
...
export declare enum Richting {
    Heen = "HEEN",
    HeenEnTerug = "HEEN_EN_TERUG"
}
export declare enum VerstoringsType {
    Evenement = "EVENEMENT",
...
export declare enum CrowdForecast {
    High = "HIGH",
    Low = "LOW",
    Medium = "MEDIUM",
    Unknown = "UNKNOWN"
...
export declare enum TravelClass {
...
export declare enum AdviceSource {
    Google = "GOOGLE",
    NS = "NS",
